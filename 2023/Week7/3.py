...
# a list with 5 elements: the minimum number, the maximum number, the median 
# number (use the function from Q2), the arithmetic average, and the geometric average.
