# Ask the user for a size (size) and a maximum value (max_value). 
# Write a program that randomly assigns values between 0 and max_value to a 
# size-by-size matrix.  Print the matrix to the screen, and then calculate 
