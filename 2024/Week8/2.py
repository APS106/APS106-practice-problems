# Write a program that asks the user for a matrix size (call it, n) 
# and then randomly assigns the values 1 to n2 to a n x n matrix, 
# not repeating any values! 

# If you do this in a simple, but inefficient way, you’ll notice it takes 
# longer and longer to place the next value or find the next location. 
# That’s OK for a 5 x 5 matrix but won’t be appropriate for a much larger 
# (say 1000 x 1000) matrix. So then what? Try writing a version that’s efficient, 
# that takes the same amount of time to place the first number as the last. 
# Maybe you can think of more than two different ways?
